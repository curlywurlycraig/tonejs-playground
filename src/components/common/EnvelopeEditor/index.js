...
const EnvelopeEditor = ({ envelope, onChange }) => {
  const totalEnvelopeDuration =
    envelope.attack + envelope.decay + envelope.release + ASSUMED_SUSTAIN_TIME;
    ...
    <div className={styles.container}>
      <Slider
        ...
        onChange={e =>
          onChange({
            ...envelope,
            attack: sliderValueToDuration(e.target.value)
          })
        }
      />
      ...
      <Slider
        ...
        onChange={e =>
          onChange({
            ...envelope,
            decay: sliderValueToDuration(e.target.value)
          })
        }
      />
      ...
      <Slider
        ...
        onChange={e =>
          onChange({
            ...envelope,
            sustain: sliderValueToAmplitude(e.target.value)
          })
        }
      />
      ...
      <Slider
        ...
        onChange={e =>
          onChange({
            ...envelope,
            release: sliderValueToDuration(e.target.value)
          })
        }
      />
      ...
      <svg viewBox="-0.1 -0.1 1.2 1.2">
        ...
        <line
          x1={attackLength}
          y1={0}
          x2={attackLength + decayLength}
          y2={1 - envelope.sustain}
          stroke="#fffad5"
          strokeWidth={0.01}
        />
        <line
          x1={attackLength + decayLength}
          y1={1 - envelope.sustain}
          x2={attackLength + decayLength + sustainLength}
          y2={1 - envelope.sustain}
          stroke="#fffad5"
          strokeWidth={0.01}
        />
        <line
          x1={attackLength + decayLength + sustainLength}
          y1={1 - envelope.sustain}
          x2={1}
          y2={1}
          stroke="#fffad5"
